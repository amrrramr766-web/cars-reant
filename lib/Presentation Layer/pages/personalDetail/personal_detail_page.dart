...
import 'package:car_rent/Presentation%20Layer/widget/personalDetaile/contact_info_section.dart';
import 'package:car_rent/Presentation%20Layer/widget/personalDetaile/driver_license_section.dart';
    ...
    return BlocListener<UserCubit, UserState>(
      listener: (context, state) {
        if (state is UserLoaded) {
          ...
          _expiryDate = user.license.expiryDate != null
              ? DateTime.parse(user.license.expiryDate as String)
              : null;
        }
      },
